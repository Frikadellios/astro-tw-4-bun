...
const TwoColumnFooter = () => {
  return (
    <footer
      ...
      className="font-inter w-full my-5 py-10 max-w-7xl"
    >
      ...
      <div className="mx-auto max-w-7xl px-2">
                ...
                {navigation.connect.map((item) => (
                  <div key={item.name}>
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-sm leading-6 text-muted-foreground hover:text-neon-cyan"
                    >
                      {item.name}
                    </a>
                  </div>
        ...
        <div className="flex w-full flex-col items-center justify-between gap-5 border-t border-neon-cyan/15 pt-8 my-8 sm:flex-row">
      ...
      <div className="flex gap-4 ">
        <SocialLink href="https://twitter.com/devopsick" icon={XIcon}>
          Follow me on X
        </SocialLink>
        <SocialLink href="http://github.com/Frikadellios" icon={GitHubIcon}>
          Follow me on GitHub
        </SocialLink>
